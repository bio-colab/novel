...
license: MIT
description: >
  Build AI-powered software with TypeSafe and Jev: small units of AI intelligence you
  can use like programming primitives. Its System One models, including Jev,
  turn natural language and application state into typed judgments (Choice, Noul, Score)
  and probabilities that code can combine. Use when a feature needs programmable
